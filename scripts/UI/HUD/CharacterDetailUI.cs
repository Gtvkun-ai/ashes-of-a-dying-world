...
namespace AshesofaDyingWorld.UI.HUD
{
	public partial class CharacterDetailUI : Panel
	{
		...
		private Texture2D LoadStatIcon(string statShortName)
		{
			...
			{
				"STR" => "res://data/icons/str.tres",
				"INT" => "res://data/icons/int.tres",
				"DEX" => "res://data/icons/dex.tres",
				"VIT" => "res://data/icons/vit.tres",
				"DEF" => "res://data/icons/def.tres",
				"SPI" => "res://data/icons/spi.tres",
				_ => null
			};
