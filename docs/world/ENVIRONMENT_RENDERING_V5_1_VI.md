...
## Asset mới
`assets/graphics/environment/trees/`
- `tree.png` — master chỉnh tay, 144x176.
- `apple_tree.png` — master chỉnh tay, 176x200.
- `*_canopy.png` — layer foliage runtime.
- `*_trunk.png` — layer trunk/runtime.
- `*_canopy_normal.png` — pseudo normal authored từ silhouette.
- `*_canopy_ao.png` — AO foliage.
